        ...
        <Flex
          ...
          <Modal
            ...
            >
              ...
              {
                userList.map((elm) => {
                  return <Box mb="10px" mt="10px" p="10px" cursor="pointer">{elm.firstname} | {elm.lastname} <Button position="absolute" right="25px" colorScheme="teal" size="xs">Ajouter</Button><hr/></Box>
                })
              }
