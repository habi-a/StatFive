    ...
    <Box>
      ...
      >
        ...
        <Input
          type="text"
          value={teamName}
          datatestid="equipe_input"
          placeholder="Nom de l'équipe"
          mt="25px"
          w="50%"
          errorBorderColor="red.300"
          isInvalid={teamName.length < 1}
          ml="40px"
        ...
        <Flex
          ...
          padding="40px"
        >
          <CardEmpty numberID="0" />
          <CardEmpty numberID="1" />
          <CardEmpty numberID="2" />
          <CardEmpty numberID="3" />
          <CardEmpty numberID="4" />
        </Flex>
        {arrayTeam.length === 5 && teamName.length > 0 && (
          <Button
            datatestid="equipe_button"
            ml="40px"
