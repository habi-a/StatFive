...
const Verification = () => {
  ...
  return (
    <Center w="100%" h="100vh" bgColor="blueteal.500">
      <Flex
        p={8}
        rounded="lg"
        boxShadow="black"
      ...
      >
        <Heading size="md" fontWeight="600" mb={5} color="white">
          Veuillez saisir le code reçu sur votre boîte mail
        </Heading>
        <HStack>
          <PinInput
            onComplete={verif}
