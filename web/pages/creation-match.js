import { Flex, Text, Box, Heading, Button, Input, useToast, AspectRatio } from '@chakra-ui/react'
        ...
        <Box pos="relative" left={{sm: "100px", md: "240px"}} w={{ md:"calc(100% -  240px)"}}>
                    ...
                    <Flex w="100%" justifyContent="space-evenly" flexDir="row" mb="50px">
                        <Flex justifyContent="center" flexDir="column">
                          <Text as="h1" mb="15px" fontSize="30px" textAlign="center">Equipe 1</Text>
                          <Select options={allTeam} placeholder="Choisissez une équipe" onChange={(e) => setTeamOne(e.value)}/>
                        </Flex>
                        
                        <Flex justifyContent="center" flexDir="column">
                          <Text as="h6" mb="15px" fontSize="30px" textAlign="center" >Equipe 2</Text>
                    ...
                    {mp4 === null && <Box cursor="pointer" p="50px" backgroundColor="#DFD3C3" border="3px dashed #1C3879" borderRadius="5px" {...getRootProps()}>
                      <Input {...getInputProps()} />
                      <Text fontWeight="bold" >Déposer votre fichier ici, ou cliquez pour sélectionner un fichier</Text>
                    </Box>}
                        {mp4 && <AspectRatio maxW="560px" w="560px" h="250" ratio={1} mt="25px">
                          <iframe
                            title="naruto"
                    ...
                    <Flex>
                    {mp4 && <Button mt="25px" mr="15px" background="red.600" color="white" onClick={() => setMp4(null)}>Changer de vidéo</Button>}
                    {mp4 && teamOne && teamTwo && <Button mt="25px" backgroundColor="green.600" color="white" onClick={() => addNewVideo()}>Valider la création</Button>}
                    </Flex>
                    </Flex>
        </Box>
    </Box>
